...
class BlockedSlots:
    """Класс для работы с таблицей BlockedSlots (блокированные даты и временные слоты)."""

    def __init__(self, db: Database):
        self.db = db
        self.logger = setup_logger(__name__)

    def block_day(self, block_date: date) -> None:
    ...
    def delete_blocked_slot(self, slot_id: int) -> None:
